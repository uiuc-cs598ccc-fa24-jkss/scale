# Modeler Build / Install How-To

## Building and pushing a new modeler image
...
```bash
helm install scale ./scale-full -n monitoring --create-namespace --set modeler.image.version=my-version
```
